...
public class bulletLogic : MonoBehaviour
{
    ...
    */
    void OnEnable()
    {
        ...
        playerRangedAttack playerGunStats = _player.GetComponent<playerRangedAttack>();
        if (_player.GetComponent<playerWeaponHandler>()._leftOrRight == false)
        {
            ...
            {
                this.transform.LookAt(leftGunStats._targetPoint);
            }
        ...
        else
        {
            ...
            {
                this.transform.LookAt(rightGunStats._targetPoint);
            }
        }
